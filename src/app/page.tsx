      ...
      <main className="flex-1 flex flex-col items-center justify-center w-full px-5 text-center">
        <div className="max-w-3xl space-y-8">
          ...
          <p className="text-xl md:text-2xl text-zinc-600 font-light">
            Découvrez l'avenir des paiements transfrontaliers.
            Des transferts d'argent internationaux fluides et sécurisés en Afrique.
          </p>
        ...
        <div className="mt-24 grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl w-full text-left">
          <div className="p-6 bg-white rounded-2xl shadow-sm border border-zinc-100">
            ...
            <h3 className="text-lg font-semibold mb-2">Transferts Instantanés</h3>
            <p className="text-zinc-600">Envoyez de l'argent en quelques secondes et vos bénéficiaires sont notifiés sans délai.</p>
          </div>
          <div className="p-6 bg-white rounded-2xl shadow-sm border border-zinc-100">
            ...
            <h3 className="text-lg font-semibold mb-2">Sécurité Bancaire</h3>
            <p className="text-zinc-600">Nous ne détenons jamais vos fonds. Données chiffrées selon les meilleurs standards de sécurité.</p>
          </div>
          <div className="p-6 bg-white rounded-2xl shadow-sm border border-zinc-100">
            ...
            <h3 className="text-lg font-semibold mb-2">Frais Transparents</h3>
            <p className="text-zinc-600">Seulement 0.6% sur la transaction. Vous voyez toujours exactement ce que la cible reçoit.</p>
          </div>
        </div>
      </main>

      <footer className="w-full py-6 text-center text-sm text-zinc-500">
        &copy; {new Date().getFullYear()} KoraLink. Tous droits réservés.
      </footer>
    </div>
  )
}
